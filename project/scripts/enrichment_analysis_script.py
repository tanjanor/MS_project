...
#output path
path_process = "../data/openMS/enrichment/enriched_processes.csv"
...
#plt.tight_layout()
plt.savefig("../data/openMS/enrichment/enrichment_process_plot.png")
plt.close(fig)
...
plt.subplots_adjust(left=0.4)
#plt.tight_layout()
plt.savefig("../data/openMS/enrichment/enrichment_process_plot_norm.png")
plt.close(fig)
